...
\begin{document}
	...
	\begin{itemize}
		\item \textbf{Area pubblica} (accessibile a tutti): home page di selezione del coro,  con ricerca, pagine di dettaglio per ogni coro.
	...
	\subsection{Repertorio canti}
	Il repertorio è unificato per tutti i cori. La lista di tutti i canti disponibili nel sito si trova alla pagina \texttt{/canti}, nella quale si può anche cercare un canto per titolo, momento liturgico, tempo liturgico, lingua e testo.
	
	Inoltre, nelle pagine dei singoli canti si trovano:
	\begin{itemize}
		\item il testo completo del canto;
		\item un video YouTube per ascoltare e studiare il canto;
		\item il testo in formato PDF, pronto per essere scaricato e stampato;
		\item in alcuni casi, lo spartito completo per voce.
	\end{itemize}
	
	Se si accede a una di queste pagine in modalità desktop (dal computer), aumentando lo zoom fino al 175\% spariranno tutte le sezioni eccetto il testo. Cliccando sul bottone in basso a destra si può avviare lo scrolling automatico, con la possibilità di regolarne anche la velocità. È una modalità pensata principalmente per la proiezione durante le prove e le celebrazioni.
	...
	Si raccomanda di cambiare la password dopo il primo accesso, per la sicurezza dell'account, dalla sezione 'Profilo'.\\
	...
	\subsubsection{Correggi un canto}
	...
	\subsubsection{Spartiti e accordi}
	...
	\subsubsection{Profilo personale}
	...
	\subsubsection{Aggiungi un canto nuovo}
	...
	\subsubsection{Presenze e statistiche}
